...
class Proxyupdatescorepage extends StatefulWidget {
  const Proxyupdatescorepage({super.key});

  @override
  State<StatefulWidget> createState() => _ProxyupdatescorepageState();
}

class _ProxyupdatescorepageState extends State<Proxyupdatescorepage> {
