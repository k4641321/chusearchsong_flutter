...
class RatingCalculator extends StatefulWidget {
  ...
  const RatingCalculator({super.key, this.count});
...
class _RatingCalculatorState extends State<RatingCalculator>
  ...
  void init() {
    if (widget.count != null) {
      ...
      _diffController2.text = widget.count!.toString();
      var ratingCalculatorListData = ratingCalculator(
        diff: double.parse(_diffController2.text),
        context: context,
      );
      setState(() {
        ratingCalculatorList = ratingCalculatorListData;
      });
    }
  }
