                  ...
                  child: Card(
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Text('排序方式'),
                          Text(sortingmethod, style: TextStyle(fontSize: 10)),
                        ],
                      ),
                    ),
                  ),
                          ...
                          ListTile(
                            ...
                            onTap: () {
                              setState(() {
                                ...
                                if (i['title'] != 'CHUNITHM') {
                                  versionfiltername = (i['title'] as String)
                                      .replaceAll('CHUNITHM', '');
                                } else {
                                ...
                                children: [
                                  Expanded(
                                    child: TextField(
                                      ...
                                      controller: levelfilterdowncontroller,
                                  ...
                                  Expanded(
                                    child: TextField(
                                      ...
                                      controller: levelfilterupcontroller,
                                      decoration: InputDecoration(
                                        hintText: '难度上限',
                                      ),
                                    ),
                            ...
                            children: [
                              ...
                              ListTile(
                                ...
                                onTap: () {
                                  setState(() {
                                    levelindexfilter = 5;
                                    levelindexfiltername = 'World\'s End';
                                    Navigator.pop(b);
                                  });
                                },
                              ),
                            ...
                            children: [
                              Row(
                                children: [
                                  Expanded(
                                    child: TextField(
                                      controller: scoredownfiltercontroller,
                                      decoration: InputDecoration(
                                        hintText: '最低分',
                                      ),
                                    ),
                                  ...
                                  Expanded(
                                    child: TextField(
                                      controller: scoreupfiltercontroller,
                                      decoration: InputDecoration(
                                        hintText: '最高分',
                                      ),
                                    ),
                  ...
                  child: Card(
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Text('连击筛选'),
                          Text(fcfilter, style: TextStyle(fontSize: 10)),
                        ],
                      ),
                    ),
                  ),
